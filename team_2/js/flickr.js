...
function flikrSearch(clickLat, clickLon) {
  console.log('flikrSearch')
  ...
  var rightLongitude = clickLon + rangeFilter / 30;
  var rightLatitude = clickLat + rangeFilter / 30;
  var leftLongitude = clickLon - rangeFilter / 30;
  var leftLatitude = clickLat - rangeFilter / 30;
...
//   GetApiData(latitude longitude rangeFilter photoFilter){
...
//       "async": true,
//       "crossDomain": true,
//       "url": `${flikrUrl}&api_key=${this.apiKey}&${this.formatCallback}
