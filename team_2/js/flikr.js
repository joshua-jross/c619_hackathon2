...
//       // $("#flickr").append('<img src="https://farm' + farmId + '.staticflickr.com/' + serverId + '/' + id + '_' + secret + '.jpg"/>');
//       $("#flickr").append('<img src="https://farm' + 2 + '.staticflickr.com/' +"1670" + '/' + "25776078942" + '_' + "903364c4b1" + '.jpg"/>');

//     });
//   });
// }

var photoFilter = $('#photoFilter').val();
...
function flikrSearch() {
  ...
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": `${flikrUrl}&api_key=${apiKey}&${formatCallback}&bbox=-117.9,33.6,-117.8,33.7&text=${photoFilter}`,
    "method": "GET",
    "headers": {}
  }
